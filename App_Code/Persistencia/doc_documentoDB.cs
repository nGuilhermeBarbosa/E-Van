...
public class doc_documentoDB
{
    public static int Insert(doc_documento doc)
    {
        ...
        try
        {
            ...
            objCommand.Parameters.Add(Mapped.Parameter("?doc_image", doc.Doc_image));
            // Chave estrangeira
    ...
    public static int Update(doc_documento doc)
    {
        int retorno = 0;
        ...
        try
        {
            ...
            IDbConnection objConexao; //Abrir a conexão
            IDbCommand objCommand; // Criar e executar os comandos
            string sql = "update doc_documento set doc_image = ?doc_image";
